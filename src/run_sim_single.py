...
if __name__ == '__main__':
    ...
    strategy_args = [
        (('long_tops', 4, 'low', 'HH', 8, 8), ('short_tops', 4, 'high', 'LL', 8, 8)), 
        (('long_tops', 4, 'low', 'HH', 5, 8), ('short_tops', 4, 'high', 'LL', 5, 8)), 
        (('long_tops', 5, 'low', 'HH', 8, 8), ('short_tops', 5, 'high', 'LL', 8, 8)), 
        (('long_tops', 10, 'low', 'HH', 7, 4), ('short_tops', 10, 'high', 'LL', 7, 4)), 
        (('long_tops', 10, 'low', 'HH', 5, 4), ('short_tops', 10, 'high', 'LL', 5, 4)), 
        (('long_tops', 3, 'low', 'HH', 8, 4), ('short_tops', 3, 'high', 'LL', 8, 4)), 
        (('long_tops', 10, 'low', 'HH', 8, 3), ('short_tops', 10, 'high', 'LL', 8, 3)), 
        (('long_tops', 10, 'low', 'HH', 7, 3), ('short_tops', 10, 'high', 'LL', 7, 3)), 
        (('long_tops', 10, 'low', 'HH', 5, 3), ('short_tops', 10, 'high', 'LL', 5, 3)), 
        (('long_tops', 10, 'low', 'HH', 3, 4), ('short_tops', 10, 'high', 'LL', 3, 4))
    ]
